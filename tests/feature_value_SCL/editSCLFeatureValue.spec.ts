...
import { EditFeatureSCLSteps } from '../../steps/editfeatureSCLSteps';

var classCode = "";
var familyCode = "";
var scl_familyCode = "";

test('Edit SCL feature value', async ({ page }, testInfo) => {
    ...
    const editstepSCLFeature = new EditFeatureSCLSteps(page, testInfo, helper);
    ...
    await stepSCLFeature.navigate_to_edit_SCL_family();
    stepHomepage.close_opened_genric_dict();

    //Edit SCL feature value
    await editstepSCLFeature.navigateTo_edit_SCL_feature_value(scl_familyCode);
