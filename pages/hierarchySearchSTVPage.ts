...
export class HierarchySearchSTVPage {
    ...
    constructor(page: Page) {
        ...
        this.stvStructure = page.locator("//mat-pseudo-checkbox//following-sibling::span[contains(text(),'SCL')]");
        ...
        this.countOfButton = page.locator("//div[@class='value-list STV']//button");
        this.featureFamilyCode = page.locator("div[class='subtitle ng-star-inserted'] span");
